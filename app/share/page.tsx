    ...
    <div className="mx-auto flex h-dvh w-full max-w-[480px] flex-col bg-bg">
      ...
      <div className="flex flex-col gap-2.5 border-t border-line bg-bg px-4 pb-[22px] pt-3.5">
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-xl bg-accent px-4 py-[15px] text-[15px] font-bold text-accent-ink shadow-[0_12px_24px_-10px_var(--accent)]"
        >
        ...
        <button
          ...
          className="flex items-center justify-center rounded-xl border-[1.5px] border-ink px-4 py-3.5 text-[15px] font-bold text-ink"
        >
